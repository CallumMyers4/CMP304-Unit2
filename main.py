...
dataPrep.getClusters(optimal_clusters)  #get the appropriate clusters using the optimal amount decided from the elbow check
...
dataAnalysis.defineValues(player_data, matches_played)  #gets max, avg and normalized values for all essential player data